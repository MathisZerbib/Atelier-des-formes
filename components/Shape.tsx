...
export const Shape: React.FC<ShapeProps> = ({ type, color, className = 'w-16 h-16', showDoor = false, showChimney = false }) => {
  ...
  // door rendering moved behind a prop so callers can choose whether to show it
        const doorWidth = 28;
        const doorHeight = 36;
        ...
        return (
          <g>
            ...
            {/* door only when requested by parent */}
            {showDoor && (
              <>
  ...
  case 'triangle':
      ...
      return (
        <g>
          ...
          {/* chimney and smoke only when requested by parent */}
          {showChimney && (
            <>
